                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item list-group-item-action dropdown-notifications-item">
                                <div class="d-flex">
                                    <div class="flex-shrink-0 me-3">
                                        <div class="avatar">
                                            <img src="{{ asset('profil\assets/img/avatars/1.png') }}" alt=""
                            ...
                            <li
                                ...
                                <div class="d-flex">
                                    <div class="flex-shrink-0 me-3">
                                        <div class="avatar">
                                            <img src="{{ asset('profil\assets/img/avatars/2.png') }}" alt=""
                                                class="rounded-circle">
                                        </div>
                                    </div>
                                    <div class="flex-grow-1">
                            ...
                            <li
                                ...
                                <div class="d-flex">
                                    <div class="flex-shrink-0 me-3">
                                        <div class="avatar">
                                            <img src="{{ asset('profil\assets/img/avatars/9.png') }}" alt=""
                                                class="rounded-circle">
                                        </div>
                                    </div>
                                    <div class="flex-grow-1">
                            ...
                            <li
                                ...
                                <div class="d-flex">
                                    <div class="flex-shrink-0 me-3">
                                        <div class="avatar">
                                            <img src="{{ asset('profil\assets/img/avatars/5.png') }}" alt=""
                                                class="rounded-circle">
                                        </div>
                                    </div>
                                    <div class="flex-grow-1">
                            ...
                            <li class="list-group-item list-group-item-action dropdown-notifications-item">
                                <div class="d-flex">
                                    <div class="flex-shrink-0 me-3">
                                        <div class="avatar">
                                            <img src="{{ asset('profil\assets/img/avatars/6.png') }}" alt=""
                                                class="rounded-circle">
                                        </div>
                                    </div>
                                    <div class="flex-grow-1">
                    ...
                    <li>
                        @if (Auth::check() && Auth::user()->role == 'admin')
                            <a class="dropdown-item" href="{{ url('admin/dashboard') }}">
                                <i class="icon-base bx bx-tachometer icon-md me-3"></i><span>Dashboard Admin</span>
                            </a>
                        @endif
                    </li>

                    <li>
                        <a class="dropdown-item" href="{{ url('user/home') }}"> <i
                                class="icon-base bx bx-home icon-md me-3"></i><span>Home</span> </a>
                    </li>
                    <li>
                        <a class="dropdown-item" href="{{ route('logout') }}"
                            onclick="event.preventDefault(); document.getElementById('logout-form').submit();"
                            target="_blank"> <i class="icon-base bx bx-power-off icon-md me-3"></i><span>Log
                                Out</span> </a>
