    ...
    <ul class="navbar-nav navbar-right">
        ...
        <li class="dropdown">
            <a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                ...
                <div class="d-sm-none d-lg-inline-block">Hi, {{ $user->first()->name }}</div>
            </a>
            <div class="dropdown-menu dropdown-menu-right">
                <div class="dropdown-title">Logged in 5 min ago</div>
                <a href="{{ url('user/home') }}" class="dropdown-item has-icon"> <i class="fas fa-home"></i></i>
                    Home
                </a>
                <a href="{{ url('profil/dashboard') }}" class="dropdown-item has-icon"> <i
